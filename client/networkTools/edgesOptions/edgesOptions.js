        ...
        'change #edgesColor': function(e, template) {
            ...
            if (val == 'file') {
                ...
                net.edges().forEach(function(ele) {
                    ...
                    console.log(Edges)
                    console.log("FIND MY EDGE PLEASE", Edges.findOne({
                        "data.data.id": ele.data().data.id
                    }))
                    // var EdgeForCopyToMap= Edges.upsert({
                    //     "data.data.id": ele.data().data.id
                    // },{$set: {"data.data.colortmp": color}})
                    var fooscratch = ele.scratch('color' ,{color})
                    console.log(fooscratch)
                    console.log(foo= ele.scratch('color'))
                    console.log("FIND ME ANY EDGE PLEASE", Edges.findOne())
                    console.log("AM I BEING PLAYED HERE??")
